...
<span style="color:lime;">You need to have **_Java 21_** installed and configured in your PATH variable
...
* <span style="color:lime;">but for those who wish to install gradle locally - the version is **_8.5_**
## <span style="color:magenta;"> For Docker Users

* <span style="color:cyan;">In the root project directory execute the following commands using either gradle or ./gradlew
...
* <span style="color:cyan;">this will add necessary kafka topics to the boostrap servers. Can be deleted afterwards
...
* <span style="color:cyan;">Then go to infrastructure/database-migrations directory from repository root
...
* <span style="color:orange;">Orders made in rekindle network are handled seamlessly via events orchestrated by Apache Kafka
> zookeeper 
> 
> 3 kafka brokers
> 
...
* <span style="color:orange;">At the moment there is one central database but more will be introduced for each microservice
* <span style="color:orange;">To connect to the PostgreSQL Database please install the latest version
...
* <span style="color:orange;">Kafka, zookeeper and postgres are mapped to folders inside the project for simplicity
...
* <span style="color:orange;">In case of docker container removals, contents of these folders also have to be deleted
