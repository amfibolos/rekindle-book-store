...
public class BookstoreApprovalResponseAvroModel extends
   ...
   */
  public static BinaryMessageDecoder<BookstoreApprovalResponseAvroModel> createDecoder(
   ...
   */
  public BookstoreApprovalResponseAvroModel(
      String id, String sagaId, String bookstoreId, String orderId, java.time.Instant createdAt,
      OrderApprovalStatus orderApprovalStatus, java.util.List<String> failureMessages
  ) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
      ...
      case 4:
        ...
        break;
      case 5:
        orderApprovalStatus = (OrderApprovalStatus) value$;
        break;
      case 6:
  ...
  public static class Builder extends
      org.apache.avro.specific.SpecificRecordBuilderBase<BookstoreApprovalResponseAvroModel>
    ...
    public BookstoreApprovalResponseAvroModel build() {
      try {
        ...
        record.orderApprovalStatus = fieldSetFlags()[5] ? this.orderApprovalStatus
            : (OrderApprovalStatus) defaultValue(fields()[5]);
        record.failureMessages = fieldSetFlags()[6] ? this.failureMessages
            : (java.util.List<String>) defaultValue(fields()[6]);
        return record;
  ...
  private static final org.apache.avro.io.DatumWriter<BookstoreApprovalResponseAvroModel>
      WRITER$ = (org.apache.avro.io.DatumWriter<BookstoreApprovalResponseAvroModel>) MODEL$.createDatumWriter(
      SCHEMA$);
  ...
  private static final org.apache.avro.io.DatumReader<BookstoreApprovalResponseAvroModel>
      READER$ = (org.apache.avro.io.DatumReader<BookstoreApprovalResponseAvroModel>) MODEL$.createDatumReader(
      SCHEMA$);
