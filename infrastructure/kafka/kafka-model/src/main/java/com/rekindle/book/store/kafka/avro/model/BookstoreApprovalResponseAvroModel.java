...
public class BookstoreApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2769741745274074048L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"BookstoreApprovalResponseAvroModel\",\"namespace\":\"com.rekindle.book.store.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"sagaId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"bookstoreId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"createdAt\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"orderApprovalStatus\",\"type\":{\"type\":\"enum\",\"name\":\"OrderApprovalStatus\",\"symbols\":[\"APPROVED\",\"REJECTED\"]}},{\"name\":\"failureMessages\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}}]}");
  ...
  private static final BinaryMessageEncoder<BookstoreApprovalResponseAvroModel> ENCODER =
      new BinaryMessageEncoder<BookstoreApprovalResponseAvroModel>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<BookstoreApprovalResponseAvroModel> DECODER =
      new BinaryMessageDecoder<BookstoreApprovalResponseAvroModel>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<BookstoreApprovalResponseAvroModel> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<BookstoreApprovalResponseAvroModel> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<BookstoreApprovalResponseAvroModel> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<BookstoreApprovalResponseAvroModel>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this BookstoreApprovalResponseAvroModel to a ByteBuffer.
  ...
  /**
   * Deserializes a BookstoreApprovalResponseAvroModel from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a BookstoreApprovalResponseAvroModel instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static BookstoreApprovalResponseAvroModel fromByteBuffer(
   ...
   */
  public BookstoreApprovalResponseAvroModel(String id, String sagaId, String bookstoreId, String orderId, java.time.Instant createdAt, OrderApprovalStatus orderApprovalStatus, java.util.List<String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  /**
   * Creates a new BookstoreApprovalResponseAvroModel RecordBuilder.
   * @return A new BookstoreApprovalResponseAvroModel RecordBuilder
   */
  ...
  /**
   * Creates a new BookstoreApprovalResponseAvroModel RecordBuilder by copying an existing Builder.
  ...
  /**
   * Creates a new BookstoreApprovalResponseAvroModel RecordBuilder by copying an existing BookstoreApprovalResponseAvroModel instance.
   * @param other The existing instance to copy.
   * @return A new BookstoreApprovalResponseAvroModel RecordBuilder
   */
  public static Builder newBuilder(BookstoreApprovalResponseAvroModel other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  /**
   * RecordBuilder for BookstoreApprovalResponseAvroModel instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BookstoreApprovalResponseAvroModel>
    implements org.apache.avro.data.RecordBuilder<BookstoreApprovalResponseAvroModel> {
    ...
    /**
     * Creates a Builder by copying an existing BookstoreApprovalResponseAvroModel instance
     * @param other The existing instance to copy.
     */
    private Builder(BookstoreApprovalResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    public BookstoreApprovalResponseAvroModel build() {
      try {
        BookstoreApprovalResponseAvroModel record = new BookstoreApprovalResponseAvroModel();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<BookstoreApprovalResponseAvroModel>
    WRITER$ = (org.apache.avro.io.DatumWriter<BookstoreApprovalResponseAvroModel>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<BookstoreApprovalResponseAvroModel>
    READER$ = (org.apache.avro.io.DatumReader<BookstoreApprovalResponseAvroModel>)MODEL$.createDatumReader(SCHEMA$);
