...
import com.rekindle.book.store.kafka.config.KafkaConfiguration;
import com.rekindle.book.store.kafka.config.KafkaProducerConfiguration;
...
public class KafkaProducerConfig<K extends Serializable, V extends SpecificRecordBase> {
  ...
  private final KafkaConfiguration kafkaConfigurationData;
  private final KafkaProducerConfiguration kafkaProducerConfigData;

  public KafkaProducerConfig(
      KafkaConfiguration kafkaConfigurationData,
      KafkaProducerConfiguration kafkaProducerConfigData
  ) {
  ...
  public Map<String, Object> producerConfig() {
    ...
    props.put(kafkaConfigurationData.getSchemaRegistryUrlKey(),
