package com.rekindle.book.store.kafka.consumer;

import com.rekindle.book.store.kafka.config.KafkaConfiguration;
import com.rekindle.book.store.kafka.config.KafkaConsumerConfiguration;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
  ...
  private final KafkaConfiguration kafkaConfigData;
  private final KafkaConsumerConfiguration kafkaConsumerConfigData;

  public KafkaConsumerConfig(
      KafkaConfiguration kafkaConfigData,
      KafkaConsumerConfiguration kafkaConsumerConfigData
  ) {
