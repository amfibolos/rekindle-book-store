...
import com.rekindle.book.store.order.application.service.domain.ports.input.message.listener.payment.PaymentResponseMessageListener;
...
public class PaymentResponseKafkaListener implements KafkaConsumer<PaymentResponseAvroModel> {
  ...
  @Override
  @KafkaListener(id = "${kafka-consumer-config.payment-consumer-group-id}", topics = "${order-service-topics.payment-response-topic-name}")
  public void receive(
